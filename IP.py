# -*- coding:utf-8 -*-
# author:allen权 转 FreeBuf.com
import sys
import urllib2
import json

def get_ip_information(ip):
    url='http://api.map.baidu.com/highacciploc/v1?qcip='+ip+'&qterm=pc&ak='+'WqFl4vQpXOil0cFjhGpKUqRAEV4jlUTq'+'&coord=bd09ll&extensions=3'
    poiss=''
...
if __name__ == '__main__':
        get_ip_information('61.189.20.22')
